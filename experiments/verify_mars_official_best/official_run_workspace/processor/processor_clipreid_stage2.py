...
def do_train_stage2(cfg,
    ...
    def generate_cluster_features(labels, features):
        ...
        ]  # 对同一类的特征进行平均，得到聚类中心，用于初始化memory bank

        centers = torch.stack(centers, dim=0)
        return centers  # torch.Size([79, 2048])
    ...
    for epoch in range(1, epochs + 1):
        ...
        # for n_iter, (img, vid, target_cam) in enumerate(train_loader_stage2):
            ...
            with amp.autocast(enabled=True):
                ...
                score1 = score[0:3]
                score2 = score[3]
                # logits1 = image_features @ cluster_features.t()
                # logits2 = image_features[1] @ cluster_features.t()
