...
from processor.processor_clipreid_stage2 import do_train_stage2, do_inference_rrs
...
if __name__ == '__main__':
	...
	#
	model.load_param('/media/ycy/ba8af05f-f397-4839-a318-f469b124cbab/CLIP-eval-folds/LSVID-datasets/4.one-stage+msg+pv/only-cross/logs/mars_vit_clip_reid_newprompt+dense_meanp/best_model.pth.tar')
